...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100">
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" @submit.prevent="login">
      <h2 class="text-2xl mb-4 font-bold text-center">Sign In</h2>
      <div class="mb-4">
      ...
      <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded block w-full focus:outline-none focus:shadow-outline" type="submit">Sign In</button>

      <div class="text-center mt-4">
        <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="#">Forgot your account?</a>
        <span class="text-gray-500 mx-2">·</span>
        <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="#">Register</a>
      </div>
