...
const options = [
  { label: 'Public', value: 'public', icon: 'fa-solid fa-earth' },
  { label: 'Friends', value: 'friends', icon: 'fa-solid fa-user-friends' },
  { label: 'Private', value: 'private', icon: 'fa-solid fa-lock' },
  { label: 'Followers', value: 'followers', icon: 'fa-solid fa-users-line' },
  { label: 'Followers & Friends', value: 'followers-plus-friends', icon: 'fa-solid fa-users-between-lines' }
];
