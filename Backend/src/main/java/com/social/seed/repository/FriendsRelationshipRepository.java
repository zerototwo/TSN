...
public interface FriendsRelationshipRepository extends Neo4jRepository<SocialUser, String> {
        ...
        @Query("""
                        ...
                        """)
        void acceptedRequestFriendship(String idUserRequest, String idUserToAcceptedFriendRequest,
        ...
        @Query(value = """
                            ...
                            RETURN uf, COALESCE(false, null) as isRequestFriendshipSending, COALESCE(false, null) as isRequestFriendshipReceived, isFollower, isFollow, mutualFriends, COALESCE(false, null) as isFriend
                        """, countQuery = """
                            MATCH (au:SocialUser {identifier: $idUserRequest})
                            MATCH (uf:SocialUser)
                            WHERE au <> uf AND NOT (uf)-[:FRIEND_OF]-(au)
